// Henon Chaotic Dynamics - Interactive 3D Visualization
// Enhanced particle system with adaptive performance optimization
...
function draw() {
    ...
    // Update particles using Henon dynamics
    for (var i = 0; i < currentDots; i++) {
        ...
        // Henon map equations
        nx[i] = 1 - a * x[i] * x[i] + y[i];
        ny[i] = b * x[i];
        // Add a third dimension for 3D visualization
        nz[i] = 0.1 * (x[i] * y[i] - z[i]);

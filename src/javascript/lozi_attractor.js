...
// Lozi attractor parameters
var a = 1.7;  // Default Lozi parameter
var b = 0.5;  // Default Lozi parameter
var dt = 0.01;
var r = 20;
var l = 0;
var s = 1;
...
function draw() {
    ...
    // Update particles using Lozi map
    for (var i = 0; i < currentDots; i++) {
        ...
        // Lozi map equations
        var newX = 1 - a * Math.abs(x[i]) + y[i];
        var newY = b * x[i];
        
        x[i] = newX;
        y[i] = newY;
        // Add slight 3D variation for visual interest
        z[i] += (newX - newY) * 0.1;
